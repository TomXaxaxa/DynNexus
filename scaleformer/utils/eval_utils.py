"""Utilities for evaluation dataset loading and result persistence."""
...
def get_eval_data_dict(
    ...
    """Collect evaluation datasets grouped by system name.

    Args:
        data_paths_lst: List of root directories containing test data.
        num_subdirs: Optional maximum number of system subdirectories to use.
        num_samples_per_subdir: Optional max number of files per subdirectory.
        one_dim_target: Whether to read targets as univariate series.
    """
    # get test data paths
