"""Dataset and sampler utilities for ScaleFormer training/evaluation."""
...
class PseudoShuffledIterableDataset(IterableDataset):
    """Streaming pseudo-shuffle wrapper for iterable datasets."""
...
class TimeSeriesDataset(IterableDataset):
    """Unified iterable dataset for training, validation and test windows."""
